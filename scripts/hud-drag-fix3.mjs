...
// Normalize CRLF → LF so template-literal matches work on Windows
let c = readFileSync(f, 'utf-8').replace(/\r\n/g, '\n');
let ok = 0, miss = 0;
...
// 1. Replace isDragHandleTarget + startPanelDrag with makeHandleDrag
rep('1:functions',
